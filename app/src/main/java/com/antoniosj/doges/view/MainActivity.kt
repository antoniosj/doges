...
import com.antoniosj.doges.util.PERMISSION_SEND_SMS
...
class MainActivity : AppCompatActivity() {
    ...
    private fun notifyDetailFragment(permissionGranted: Boolean) {
        ...
        // the user can click send sms and then back to another fragment, so we need to check.
